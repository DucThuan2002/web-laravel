				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{ asset('public/frontend/images/logo.pn')}}g" alt="" /></a>
						</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand_pro->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand_pro->brand_name}}</a></li>
								</ul>
							</div>
							@endforeach
						</div><!--/brands_products-->
