...
// chi tiết sản phẩm
Route::get('/chi-tiet-san-pham/{product_id}','App\Http\Controllers\ProductController@show_detail_product');
...
Route::post('/update-product/{product_id}/{image}','App\Http\Controllers\ProductController@update_product');

Route::get('/delete-product/{product_id}/{image}','App\Http\Controllers\ProductController@delete_product');
...
Route::post('/orders-place','App\Http\Controllers\CheckoutController@orders_place');
